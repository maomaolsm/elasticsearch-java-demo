package com.es.example.process;
...
public class ElasticSearchHandler {
    ...
    private void initClient() {
        // 使用本机作为节点
        try {
            // 如果cluster名称不是默认的"elasticsearch"，通过以下方式可设置
            /*
            ...
            */
            ...
            Settings settings = Settings.settingsBuilder()
                    .put("cluster.name", "elasticsearch_JYD").build();
    ...
    public void createIndex(String indexName, String type, List<String> dataList) {
        ...
        dataList.forEach(data -> requestBuilder.setSource(data).setId(data.substring(6,7)).execute().actionGet());
